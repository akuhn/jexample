...
%not sure, if this example is ok, because in TestNG you still need the setup method
...
\lstinputlisting[label=lst:ullmanorig,breaklines=true,caption=TestUllman.java]{tests/TestUllman.java}

\section{Ullman refactored}
\lstinputlisting[label=lst:ullmancomp,breaklines=true,caption=IsomorphTestUllman.java]{tests/IsomorphTestUllman.java}
\lstinputlisting[label=lst:ullmancomp,breaklines=true,caption= SimpleSubgraphTest.java]{tests/SimpleSubgraphTest.java}
\lstinputlisting[label=lst:ullmancomp,breaklines=true,caption= SpecialSubgraphTest.java]{tests/SpecialSubgraphTest.java}
\lstinputlisting[label=lst:ullmancomp,breaklines=true,caption= VertexPairTest.java]{tests/VertexPairTest.java}
