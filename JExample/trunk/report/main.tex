...
\end{enumerate}
In \JExample the \ttt{ComposedTestRunner} is only a delegator. The reason for that is explained in the section about the real runner, the \ttt{TestGraph}.
...
\lstinputlisting[breaklines=true,tabsize=2,firstline=21,caption=IsomorphTestUllman.java]{tests/IsomorphTestUllman.java}
\newpage
\lstinputlisting[breaklines=true,tabsize=2,firstline=22,caption= SimpleSubgraphTest.java]{tests/SimpleSubgraphTest.java}
\newpage
\lstinputlisting[breaklines=true,tabsize=2,firstline=15,caption= SpecialSubgraphTest.java]{tests/SpecialSubgraphTest.java}
\newpage
\lstinputlisting[breaklines=true,tabsize=2,firstline=15,caption= VertexPairTest.java]{tests/VertexPairTest.java}
