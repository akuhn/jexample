...
public class MethodCollector {
	...
	private void addMethodsToMap( Collection<Method> methodsToAdd ) {
		for ( Method method : methodsToAdd ) {
			this.methods.put( method, new TestMethod(method) );
		}
	}

	public Map<Method,TestMethod> collectTestMethods() throws SecurityException, NoSuchMethodException, ClassNotFoundException {
	...
	private void processMethods( Set<Method> set ) throws SecurityException, NoSuchMethodException, ClassNotFoundException {
