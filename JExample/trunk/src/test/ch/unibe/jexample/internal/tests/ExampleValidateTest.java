...
public class ExampleValidateTest {
    ...
    public void testSameTypes() throws SecurityException, NoSuchMethodException {
        // assertEquals( 0, this.validator.dependencyIsValid(
        // this.stringAsParam, this.returnsString ).size() );
        //
        // assertEquals( 0, this.validator.dependencyIsValid( this.twoParams,
        // this.returnsString, this.returnsInt ).size() );
    }

    @Test
    public void testWrongOrder() throws SecurityException, NoSuchMethodException {
        // assertEquals( 2, this.validator.dependencyIsValid( this.twoParams,
        // this.returnsInt, this.returnsString ).size() );
    }

    @Test
    public void testReturnTypeVoid() throws SecurityException, NoSuchMethodException {
        // assertEquals( 0, this.validator.dependencyIsValid(
        // this.returnsString, this.voidReturnType ).size() );
    }

    @Test
    public void testDifferentTypes() throws SecurityException, NoSuchMethodException {
        // assertEquals( 1, this.validator.dependencyIsValid(
        // this.stringAsParam, this.voidReturnType ).size() );
    }
    ...
    public void testReturnTypeNotVoid() throws SecurityException, NoSuchMethodException {
        ...
        // assertEquals( 0, this.validator.dependencyIsValid(
        // this.voidReturnType, this.returnsString ).size() );
    }

    @Test
    public void testNumberOfTypes() throws SecurityException, NoSuchMethodException {
        // assertEquals( 1, this.validator.dependencyIsValid(
        // this.stringAsParam, this.returnsString, this.voidReturnType )
        // .size() );
    }

    @Test
    public void testDependencyHasToBeTestMethod() {
        // assertEquals( 1, this.validator.dependencyIsValid( this.returnsInt,
        // this.noTestMethod ).size() );
    }

    @Test
    public void testDependencyCannotBeItself() {
        // assertEquals( 1, this.validator.dependencyIsValid( this.returnsInt,
        // this.returnsInt ).size() );
    }
